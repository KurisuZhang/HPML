...
Original file is located at
    https://colab.research.google.com/drive/1kRh-g8NA9NiaiJNJ2TdwCB6EJQi7jn0f
...
parse.add_argument('--lr', default = 0.01, type = float, help = 'learning rate')
parse.add_argument('--opt', default = 'sgd', type = str, help = 'optimizer')
parse.add_argument('--cuda', default = 'cpu', type = str, help = 'cuda')
parse.add_argument('--num_workers', default = 2, type = int, help = 'num_workers')
...
def train(epoch,num_worker):
    ...
    # print('[Train]: Epoch: %d | num_worker: %d | Loss: %.3f | Acc: %.3f%% | time_loading: %.4f | time_training: %.4f'% (epoch+1, num_worker,train_loss/(100), 100.*correct/total,time_loading,time_training))
...
for epoch in range(0, 5):
    l_time,r_time = train(epoch,num_workers)
    load_time.append(l_time)
    run_time.append(r_time)
print('num_worker:',num_workers)
print('Data-loading time for each epoch:',load_time)
#print('Training time for each epoch:',run_time)
print('Total running time for each epoch',[a + b for a, b in zip(load_time, run_time)] )
