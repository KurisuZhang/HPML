...
Original file is located at
    https://colab.research.google.com/drive/1El7fUodfPWb3ZVtYQ7pWkkH00zeWZjQX
...
def train(epoch):
    ...
    print('[Train]: Epoch: %d | Loss: %.3f | Acc: %.3f%% | time_loading: %.4f | time_training: %.4f'% (epoch+1, train_loss/(100), 100.*correct/total,time_loading,time_training))
